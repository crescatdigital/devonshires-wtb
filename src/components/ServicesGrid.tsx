          ...
          {content.cards.map((card) => (
            ...
            >
              ...
              <div className="flex flex-1 flex-col items-start bg-deep px-[35px] pb-[40px] pt-[32px]">
                <p className="text-[22px] font-semibold tracking-[0.08em] text-mint">
                  {card.label}
                </p>
                <h3 className="mt-[18px] font-heading text-[45px] text-white">
                  {card.title}
                </h3>
                <p className="mt-[16px] text-[24px] leading-normal text-white">{card.text}</p>
                <a
                  href={card.link.href}
                  className="mt-auto flex items-center gap-[14px] pt-[30px] text-[32px] text-flame"
                >
                  {card.link.label}
